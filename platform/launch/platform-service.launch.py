...
def generate_launch_description():
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'a300_0000/cmd_vel@geometry_msgs/msg/TwistStamped[gz.msgs.Twist'
                ,
                '/model/a300_0000/robot/cmd_vel@geometry_msgs/msg/TwistStamped]gz.msgs.Twist'
                ,
            ]
        ,
        remappings=
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/a300_0000/robot/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
